...
public:
    ...
    // ToDo: see if using pointer here is worth it, cloning via pointer?
...
public:
    ...
    //        mFminEnv( std::make_unique <LinearEnvelope>( fmin ) ),
        //mFminEnv( std::make_unique <LinearEnvelope>( fmin ) ),
...
//        bwAssociator.reset( std::make_unique< AssociateBandwidth >( bwRegionWidth(), srate ) );
